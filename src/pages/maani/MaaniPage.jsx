...
export default function Maani() {
  ...
  return (
    <div className="about-container">
      ...
      <div className="card" style={{ padding:"30px",textAlign: "justify",}}>
        <p className="para">{content[active]}</p>
      </div>
